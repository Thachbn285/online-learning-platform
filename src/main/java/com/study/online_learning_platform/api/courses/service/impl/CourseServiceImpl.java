...
public class CourseServiceImpl implements ICourseService {
    ...
    public List<CourseDTO> findAll() {
        ...
        courseDTOs = courseEntities.stream()
    ...
    public ResponseEntity<ResponseDTO> create(CourseDTO courseDTO) {
        ...
        if (courseDTO.getCourseId() != null && courseRepository.existsById(courseDTO.getCourseId())) {
            responseDTO.setMessage("CREATE FAIL");
            details.add("Khóa học đã tồn tại với id: " + courseDTO.getCourseId());
        ...
        try {
            ...
            details.add("Đã thêm thành công khóa học mới với id: " + savedEntity.getCourseId());
            responseDTO.setDetails(details);
